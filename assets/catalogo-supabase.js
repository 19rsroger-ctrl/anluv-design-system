...
window.AnluvCatalogReady = (async function () {
  ...
  const productos = data.map(p => ({
    ...
    resumen: p.summary || '',
    specs: p.specs || {},
    model3d: p.model_3d_url || '', model3dIos: p.model_3d_ios_url || '', model: p.model || '', sku: p.sku || '', gtin: p.gtin || '', mpn: p.mpn || '', warranty: p.warranty || '', imageAlt: p.image_alt || '', seoTitle: p.seo_title || '', seoDescription: p.seo_description || '',
  }));
